...
namespace jakaApi
{
	...
	public class jakaAPI
	{
		...
		[DllImport("jakaAPI.dll", EntryPoint = "joint_move_super", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern int joint_move_super(ref int handle, ref JKTYPE.MoveJParam param);

		[DllImport("jakaAPI.dll", EntryPoint = "linear_move_super", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern int linear_move_super(ref int handle, ref JKTYPE.MoveLParam get_dh_param);

		[DllImport("jakaAPI.dll", EntryPoint = "circular_move_super", ExactSpelling = false, CallingConvention = CallingConvention.Cdecl)]
		public static extern int circular_move_super(ref int handle, ref JKTYPE.MoveCParam param);
		...
		public static extern int get_robot_state(ref int handle, ref JKTYPE.RobotStatus state);
		...
		public static extern int get_motion_status(ref int i, ref JKTYPE.MotionStatus motion_status);
		...
		#region torque sensor and force control
